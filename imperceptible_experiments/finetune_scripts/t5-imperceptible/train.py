...
def step1_train_clean():
    trainer, tokenizer = get_trainer("datasets/text/ag_news/oneshot/clean_full_train.csv")
    trainer.train()
...
def step2_train_perturbed():
    files = [
        "datasets/text/ag_news/oneshot/homoglyphs_full_1to5_train.csv",
        "datasets/text/ag_news/oneshot/deletions_full_1to5_train.csv",
        "datasets/text/ag_news/oneshot/invisible_full_1to5_train.csv",
        "datasets/text/ag_news/oneshot/reorderings_full_1to5_train.csv"
    ]
    
    merged_csv = "datasets/text/ag_news/oneshot/perturbed_combined_train.csv"
    (
