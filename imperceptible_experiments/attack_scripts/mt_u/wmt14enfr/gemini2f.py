import textattack
from imperceptible_experiments.model_wrappers.mt_u.gemini2f import Gemini2FlashWrapperMT
...
model_wrapper = Gemini2FlashWrapperMT("Translate the following sentence from English to French, outputting the sentence only:")
