import textattack
from imperceptible_experiments.model_wrappers.mt_u.gpt4o import GPT4oWrapperMT
...
model_wrapper = GPT4oWrapperMT("Translate the following sentence from English to French, outputting the sentence only:")
