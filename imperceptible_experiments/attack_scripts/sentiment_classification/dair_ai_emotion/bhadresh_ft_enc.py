...
model = pipeline("text-classification", model="models/bhadresh_ft_enc/checkpoints", tokenizer="models/bhadresh_ft_enc/checkpoints", return_all_scores=True, device=device)
