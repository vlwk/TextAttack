...
T5_DIR = "models/t5_ft_perturbed"  # or use _clean if preferred
BATCH_SIZE = 32
MAX_LEN = 128
...
OUTPUT_DIR = os.path.join("results/sentiment_classification/dair_ai_emotion", "oneshot", "bhadresh_with_t5_cleaner")
...
def main():
    ...
    for name, path in TEST_FILES.items():
        ...
        # 🧼 Run perturbed inputs through T5 pre-tokeniser
        if name != "clean":
