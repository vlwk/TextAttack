...
from imperceptible_experiments.model_wrappers.sc_t.gemini2f import Gemini2FlashWrapperSC
...
BATCH_SIZE = 8
OUTPUT_DIR = os.path.join("results/sc_o/emotion_perturbed_test", "gemini2f")
...
# === MAIN ===
def main():
    model_wrapper = Gemini2FlashWrapperSC(system_prompt=SYSTEM_PROMPT, no_classes=6)
