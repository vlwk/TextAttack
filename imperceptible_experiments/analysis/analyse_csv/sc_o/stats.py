...
def main():
    ...
    input_path = os.path.join(
        "results", "sc_o", args.dataset_name, args.model_name, f"logits_{args.perturbation_type}.jsonl"
    )
    ...
    output_path = os.path.join(
        "analysis", "sc_o", args.dataset_name, args.model_name, f"{args.perturbation_type}.txt"
    )
